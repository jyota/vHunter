#    geom_intersection.py
#
#    Original copyright below. I added a helper function to evaluate
#    if a line intersects a rectangle. - Jyota Snyder - 2015
#
...
# rectangles then the lines intersect. Returns intersect point if the lines
# intersect or None if not
...
def calculateLineIntersectsRectangle(p1, p2, rectangle):
	# wrapper function to check if line intersects any rectangle lines
	res = [calculateIntersectPoint(p1, p2, (rectangle.x, rectangle.y), (rectangle.x + rectangle.width, rectangle.y)), 
	       calculateIntersectPoint(p1, p2, (rectangle.x, rectangle.y), (rectangle.x, rectangle.y + rectangle.height)),
	       calculateIntersectPoint(p1, p2, (rectangle.x, rectangle.y + rectangle.height), (rectangle.x + rectangle.width, rectangle.y + rectangle.height)),
	       calculateIntersectPoint(p1, p2, (rectangle.x + rectangle.width, rectangle.y), (rectangle.x + rectangle.width,  rectangle.y + rectangle.height))]
